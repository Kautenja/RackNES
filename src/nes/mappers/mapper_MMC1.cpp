...
MapperMMC1::MapperMMC1(Cartridge* cart, std::function<void(void)> mirroring_cb) :
    Mapper(cart),
...
void MapperMMC1::writePRG(NES_Address address, NES_Byte value) {
...
void MapperMMC1::calculatePRGPointers() {
...
void MapperMMC1::writeCHR(NES_Address address, NES_Byte value) {
