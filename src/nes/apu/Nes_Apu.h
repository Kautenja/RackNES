...
class Nes_Apu {
 public:
    ...
    // first parameter.
    void dmc_reader(RomReaderCallback callback, void* user_data = NULL );
...
inline cpu_time_t Nes_Apu::earliest_irq() const { return earliest_irq_; }

inline void Nes_Apu::dmc_reader(RomReaderCallback callback, void* user_data ) {
