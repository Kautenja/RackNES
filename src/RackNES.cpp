...
struct RackNES : Module {
    ...
    RackNES() {
        ...
        configParam<TriggerParamQuantity>(PARAM_SAVE,  0.f, 1.f, 0.f, "Save State");
        configParam<TriggerParamQuantity>(PARAM_LOAD,  0.f, 1.f, 0.f, "Load State");
        configParam<TriggerParamQuantity>(PARAM_HANG,  0.f, 1.f, 0.f, "Hang Emulation");
        configParam<TriggerParamQuantity>(PARAM_RESET, 0.f, 1.f, 0.f, "Reset NES");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_A,      0.f, 1.f, 0.f, "Player 1 A");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_B,      0.f, 1.f, 0.f, "Player 1 B");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_SELECT, 0.f, 1.f, 0.f, "Player 1 Select");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_START,  0.f, 1.f, 0.f, "Player 1 Start");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_UP,     0.f, 1.f, 0.f, "Player 1 Up");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_DOWN,   0.f, 1.f, 0.f, "Player 1 Down");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_LEFT,   0.f, 1.f, 0.f, "Player 1 Left");
        configParam<TriggerParamQuantity>(PARAM_PLAYER1_RIGHT,  0.f, 1.f, 0.f, "Player 1 Right");
        configParam<TriggerParamQuantity>(PARAM_PLAYER2_A,      0.f, 1.f, 0.f, "Player 2 A");
        configParam<TriggerParamQuantity>(PARAM_PLAYER2_B,      0.f, 1.f, 0.f, "Player 2 B");
        configParam<TriggerParamQuantity>(PARAM_PLAYER2_SELECT, 0.f, 1.f, 0.f, "Player 2 Select");
        configParam<TriggerParamQuantity>(PARAM_PLAYER2_START,  0.f, 1.f, 0.f, "Player 2 Start");
        configParam<TriggerParamQuantity>(PARAM_PLAYER2_UP,     0.f, 1.f, 0.f, "Player 2 Up");
